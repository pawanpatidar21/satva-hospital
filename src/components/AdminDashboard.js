...
const AdminDashboard = () => {
    ...
    // Fetch doctors once for type→name lookup in the table
    useEffect(() => {
        getDoctors().then((list) => setDoctors(list || []));
    }, []);
        ...
        <div className="min-h-screen bg-gradient-to-br from-gray-50 via-gray-100 to-gray-50">
            ...
            <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 py-4 sm:py-6 md:py-8">
                ...
                <div className="bg-white rounded-xl sm:rounded-2xl shadow-xl mb-4 sm:mb-6 p-2 border border-gray-100">
                    <div className="flex gap-2">
                        <button
                            ...
                            className={`flex-1 px-4 sm:px-6 py-2 sm:py-3 rounded-lg font-semibold text-sm sm:text-base transition-all duration-300 transform hover:scale-105 ${activeTab === 'appointments'
                        ...
                        <button
                            ...
                            className={`flex-1 px-4 sm:px-6 py-2 sm:py-3 rounded-lg font-semibold text-sm sm:text-base transition-all duration-300 transform hover:scale-105 ${activeTab === 'doctors'
                                    ? 'bg-gradient-to-r from-primary-600 to-secondary-600 text-white shadow-lg'
                                    : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                                }`}
                        >
                ...
                {activeTab === 'appointments' && (
                    <>
                        {/* Add Appointment — prominent top CTA */}
                        <div className="mb-4 sm:mb-5 flex justify-end">
                            <button
                                onClick={openAddModal}
                                className="w-full sm:w-auto flex items-center justify-center gap-2.5 px-6 sm:px-8 py-3 sm:py-4 rounded-2xl font-bold text-base sm:text-lg bg-gradient-to-r from-primary-500 to-secondary-500 hover:from-primary-600 hover:to-secondary-600 text-white shadow-xl hover:shadow-2xl transform hover:scale-105 active:scale-95 transition-all duration-200 relative overflow-hidden group border-2 border-white/20"
                            >
                                <span className="absolute inset-0 bg-white/10 opacity-0 group-hover:opacity-100 transition-opacity duration-200 rounded-2xl"></span>
                                <span className="relative z-10 flex items-center justify-center w-8 h-8 bg-white/20 rounded-full group-hover:rotate-90 transition-transform duration-300">
                                    <FaPlus className="text-base" />
                                </span>
                                <span className="relative z-10 whitespace-nowrap">Add New Appointment</span>
                                                    ...
                                                    >
                                                        ...
                                                        <td className="px-4 md:px-6 py-4 md:py-5">
                                                            <div className="text-xs sm:text-sm text-gray-900 flex flex-col gap-0.5">
                                                                ...
                                                                {(() => {
                                                                    const type = getServiceDoctorType(appointment.service);
                                                                    const doc = doctors.find((d) => d.type === type);
                                                                    return type ? (
                                                                        <span className="text-xs text-primary-600 font-semibold ml-8">
                                                ...
                                                {getPageNumbers().map((page, index) =>
                                                    page === 'ellipsis' ? (
                                                        ...
                                                        <button key={page} onClick={() => goToPage(page)}
                                                            className={`w-8 h-8 sm:w-9 sm:h-9 rounded-lg font-semibold text-xs sm:text-sm transition-all ${currentPage === page
                                                                    ? 'bg-gradient-to-r from-primary-600 to-secondary-600 text-white shadow-lg'
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-5">
                                <div>
                                    ...
                                    <input
                                        type="text"
                                        {...registerAdd('name')}
                                        className={`w-full px-3 py-2 border-2 rounded-lg focus:ring-2 focus:ring-primary-200 outline-none text-sm sm:text-base ${addErrors.name ? 'border-red-500' : 'border-gray-300 focus:border-primary-500'
                                            }`}
                                ...
                                <div>
                                    ...
                                    <input
                                        type="tel"
                                        {...registerAdd('phone')}
                                        className={`w-full px-3 py-2 border-2 rounded-lg focus:ring-2 focus:ring-primary-200 outline-none text-sm sm:text-base ${addErrors.phone ? 'border-red-500' : 'border-gray-300 focus:border-primary-500'
                                            }`}
                                ...
                                <div className="md:col-span-2">
                                    ...
                                    <input
                                        type="email"
                                        {...registerAdd('email')}
                                        className={`w-full px-3 py-2 border-2 rounded-lg focus:ring-2 focus:ring-primary-200 outline-none text-sm sm:text-base ${addErrors.email ? 'border-red-500' : 'border-gray-300 focus:border-primary-500'
                                            }`}
                                ...
                                <div>
                                    ...
                                    <input
                                        type="text"
                                        {...registerAdd('age')}
                                        className={`w-full px-3 py-2 border-2 rounded-lg focus:ring-2 focus:ring-primary-200 outline-none text-sm sm:text-base ${addErrors.age ? 'border-red-500' : 'border-gray-300 focus:border-primary-500'
                                            }`}
                                        placeholder="e.g. 35"
                                    />
                                ...
                                <div className="md:col-span-2">
                                    ...
                                    <input
                                        type="text"
                                        {...registerAdd('address')}
                                        className={`w-full px-3 py-2 border-2 rounded-lg focus:ring-2 focus:ring-primary-200 outline-none text-sm sm:text-base ${addErrors.address ? 'border-red-500' : 'border-gray-300 focus:border-primary-500'
                                            }`}
                                        placeholder="Optional"
                                    />
                                ...
                                <div>
                                    ...
                                    <input
                                        type="date"
                                        {...registerAdd('date')}
                                        className={`w-full px-3 py-2 border-2 rounded-lg focus:ring-2 focus:ring-primary-200 outline-none text-sm sm:text-base ${addErrors.date ? 'border-red-500' : 'border-gray-300 focus:border-primary-500'
                                            }`}
                                    />
                                ...
                                <div className="md:col-span-2">
                                    ...
                                    <textarea
                                        {...registerAdd('message')}
                                        rows={2}
                                        className={`w-full px-3 py-2 border-2 rounded-lg focus:ring-2 focus:ring-primary-200 outline-none text-sm sm:text-base resize-none ${addErrors.message ? 'border-red-500' : 'border-gray-300 focus:border-primary-500'
                                            }`}
                                ...
                                <div className="md:col-span-2">
                                    ...
                                    <textarea
                                        {...registerAdd('notes')}
                                        rows={2}
                                        className={`w-full px-3 py-2 border-2 rounded-lg focus:ring-2 focus:ring-primary-200 outline-none text-sm sm:text-base resize-none ${addErrors.notes ? 'border-red-500' : 'border-gray-300 focus:border-primary-500'
                                            }`}
                        ...
                        <div className="p-4 sm:p-6 md:p-8 space-y-4 sm:space-y-5 md:space-y-6">
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 sm:gap-4">
                                        <div>
                                            ...
                                            <input
                                                type="date"
                                                {...registerUpdate('date')}
                                                className={`w-full px-3 py-2 border-2 rounded-lg focus:ring-2 focus:ring-primary-200 outline-none transition-all text-sm sm:text-base ${updateErrors.date ? 'border-red-500 focus:border-red-500' : 'border-gray-300 focus:border-primary-500'
                                                    }`}
                                            />
                                            {watchedUpdateDate && (
                                ...
                                <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-2 sm:gap-3">
                                    {['pending', 'confirmed', 'cancelled', 'completed'].map((status) => (
                                        <button
                                            ...
                                            className={`px-3 sm:px-4 py-2 sm:py-3 rounded-lg sm:rounded-xl font-bold text-xs sm:text-sm transition-all duration-300 transform hover:scale-105 ${selectedAppointment.status === status
                            ...
                            <form onSubmit={handleUpdateSubmit(onUpdateNotes)} className="bg-white p-4 sm:p-5 md:p-6 rounded-lg sm:rounded-xl border-2 border-gray-200">
                                ...
                                <textarea
                                    ...
                                    rows="4"
                                    className={`w-full px-3 sm:px-4 py-2 sm:py-3 border-2 rounded-lg sm:rounded-xl focus:ring-2 focus:ring-primary-200 outline-none transition-all resize-none text-sm sm:text-base ${updateErrors.notes ? 'border-red-500 focus:border-red-500' : 'border-gray-200 focus:border-primary-500'
                                        }`}
