              ...
              {['all', 'pending', 'confirmed', 'cancelled', 'completed'].map((status) => {
                ...
                return (
                  <button
                    ...
                    className={`inline-flex items-center gap-1.5 px-3 sm:px-4 py-1.5 sm:py-2 rounded-lg font-semibold text-xs sm:text-sm transition-all duration-300 ${
                      filter === status
                        ? 'bg-gradient-to-r from-primary-600 to-secondary-600 text-white shadow-lg'
                        : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                    }`}
                  >
                    ...
                    {count != null && (
                      <span className={`inline-flex items-center justify-center min-w-[18px] h-[18px] px-1 rounded-full text-[10px] font-bold leading-none ${
                        filter === status ? 'bg-white/30 text-white' : 'bg-gray-300 text-gray-700'
                      }`}>{count}</span>
                    )}
                  </button>
                );
                ...
                <div className="flex gap-1 p-1 bg-amber-200/50 rounded-lg mb-4 w-fit">
                  <button
                    ...
                    className={`px-3 py-1.5 rounded-md text-xs font-semibold transition-all ${
                      followUpMode === 'days' ? 'bg-white text-amber-800 shadow-sm' : 'text-amber-700 hover:text-amber-900'
                    }`}
                  >
                    📅 After Visit (days)
                  </button>
                  <button
                    ...
                    className={`px-3 py-1.5 rounded-md text-xs font-semibold transition-all ${
                      followUpMode === 'custom' ? 'bg-white text-amber-800 shadow-sm' : 'text-amber-700 hover:text-amber-900'
                    }`}
                  >
                    🗓️ Pick a Date
                  </button>
